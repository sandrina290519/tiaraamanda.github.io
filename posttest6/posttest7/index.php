  ...
  <body id="Home">
    ...
    <section class="jumbotron text-center">
      ...
      <div class="clock-container">
        ...
        $tanggalSekarang = date("l, d F Y H:i:s"); // Format: Hari, Tanggal Bulan Tahun Jam:Menit:Detik
        ?>
        <div class="time"><?php echo $tanggalSekarang; ?></div>
      </div>
    ...
    <section class="add-data">
      ...
      <div class="leading-btn">
        <a href = "regisuser.php"><button class="add-btn">Tekan tombol ini untuk memesan</button></a>
      </div><br>
    </section>
    <!-- akhir form pesanan -->
